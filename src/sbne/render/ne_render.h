...
/// @return a string containing the value of the desired feature of the Veneer object,  or an empty string if either the value of the desired feature is not set or the desired feature does not exist.
_SBNEExport const std::string ne_ven_get(Veneer* ven, std::unordered_map<std::string, std::string> infoList);

/// @brief Get the value of a desired feature of a Veneer object assgined to a Network object.
/// @param infoList a list containg the info about the desired feature.
/// @param ven a pointer to the Veneer object.
/// @param net a pointer to the Network object.
/// @return a string containing the value of the desired feature of the Veneer object  assgined to a Network object,  or an empty string if either the value of the desired feature is not set or the desired feature does not exist.
_SBNEExport const std::string ne_ven_get(Veneer* ven, Network* net, std::unordered_map<std::string, std::string> infoList);

/// @brief Set the value of a desired feature of a Veneer object.
/// @param ven a pointer to the Veneer object.
/// @param infoList a list containg the info about the desired feature and its value.
/// @return integer value indicating success/failure of the function.
_SBNEExport int ne_ven_set(Veneer* ven, std::unordered_map<std::string, std::string> infoList);

/// @brief Set the value of a desired feature of a Veneer object assgined to a Network object.
/// @param ven a pointer to the Veneer object.
/// @param net a pointer to the Network object.
/// @param infoList a list containg the info about the desired feature and its value.
/// @return integer value indicating success/failure of the function.
_SBNEExport int ne_ven_set(Veneer* ven, Network* net, std::unordered_map<std::string, std::string> infoList);
...
/// @brief Predicates returning @c true if the "backgroundcolor" attribute of this Veneer is set.
/// @param ven a pointer to the Veneer object.
...
/// @brief Get the value of a desired feature of a VColorDefinition object.
/// @param c a pointer to the VColorDefinition object.
/// @param infoList a list containg the info about the desired feature.
/// @return a string containing the value of the desired feature of the VColorDefinition object,  or an empty string if either the value of the desired feature is not set or the desired feature does not exist.
_SBNEExport const std::string ne_clr_get(VColorDefinition* c, std::unordered_map<std::string, std::string> infoList);

/// @brief Set the value of a desired feature of a VColorDefinition object.
/// @param c a pointer to the VColorDefinition object.
/// @param infoList a list containg the info about the desired feature and its value.
/// @return integer value indicating success/failure of the function.
_SBNEExport int ne_clr_set(VColorDefinition* c, std::unordered_map<std::string, std::string> infoList);

/// @brief Predicates returning @c true if the "value" attribute of this VColorDefinition is set.
/// @param c a pointer to the VColorDefinition object.
...
/// @brief Get the value of a desired feature of a VGradientBase object.
/// @param g a pointer to the VGradientBase object.
/// @param infoList a list containg the info about the desired feature.
/// @return a string containing the value of the desired feature of the VGradientBase object,  or an empty string if either the value of the desired feature is not set or the desired feature does not exist.
_SBNEExport const std::string ne_grd_get(VGradientBase* g, std::unordered_map<std::string, std::string> infoList);

/// @brief Set the value of a desired feature of a VGradientBase object.
/// @param g a pointer to the VGradientBase object.
/// @param infoList a list containg the info about the desired feature and its value.
/// @return integer value indicating success/failure of the function.
_SBNEExport int ne_grd_set(VGradientBase* g, std::unordered_map<std::string, std::string> infoList);

/// @brief Predicates returning @c true if the "spreadmethod" attribute of this VGradientBase is set.
/// @param g a pointer to the VGradientBase object.
...
/// @brief Sets the value of the "spreadmethod" attribute of this VGradientBase object.
/// @param g a pointer to the VGradientBase object.
/// @param spreadmethod a  string to use as the value of the "spreadmethod" attribute of this VGradientBase object.
/// @return integer value indicating success/failure of the function.
_SBNEExport int ne_grd_setSpreadMethod(VGradientBase* g, const std::string& spreadmethod);
...
/// @brief Predicates returning @c true if this VGradientBase object is of type VLinearGradient
/// @param g a pointer to the VGradientBase object.
...
/// @brief Predicates returning @c true if this VGradientBase object is of type VRadialGradient
/// @param g a pointer to the VGradientBase object.
...
/// @brief Predicates returning @c true if this VLinearGradient object's "x1"  RAVector object is set.
/// @param g a pointer to the VLinearGradient object.
/// @return @c true if the "x1"  RAVector object of this VLinearGradient object is set, @c false if either the "x1"  RAVector object is not set or the object is @c NULL or not a VLinearGradient.
_SBNEExport bool ne_grd_isSetX1(VGradientBase* g);
...
/// @brief Sets the "x1" RAVector object of this VLinearGradient object.
/// @param g a pointer to the VLinearGradient object.
/// @param x1 a pointer to the  "x1" RAVector object.
/// @return integer value indicating success/failure of the function.
_SBNEExport int ne_grd_setX1(VGradientBase* g, RAVector* x1);

/// @brief Predicates returning @c true if this VLinearGradient object's "y1"  RAVector object is set.
/// @param g a pointer to the VLinearGradient object.
/// @return @c true if the "y1"  RAVector object of this VLinearGradient object is set, @c false if either the "y1"  RAVector object is not set or the object is @c NULL or not a VLinearGradient.
_SBNEExport bool ne_grd_isSetY1(VGradientBase* g);
...
/// @brief Sets the "y1" RAVector object of this VLinearGradient object.
/// @param g a pointer to the VLinearGradient object.
/// @param y1 a pointer to the  "y1" RAVector object.
/// @return integer value indicating success/failure of the function.
_SBNEExport int ne_grd_setY1(VGradientBase* g, RAVector* y1);

/// @brief Predicates returning @c true if this VLinearGradient object's "x2"  RAVector object is set.
/// @param g a pointer to the VLinearGradient object.
/// @return @c true if the "x2"  RAVector object of this VLinearGradient object is set, @c false if either the "x2"  RAVector object is not set or the object is @c NULL or not a VLinearGradient.
_SBNEExport bool ne_grd_isSetX2(VGradientBase* g);
...
/// @brief Sets the "x2" RAVector object of this VLinearGradient object.
/// @param g a pointer to the VLinearGradient object.
/// @param x2 a pointer to the  "x2" RAVector object.
/// @return integer value indicating success/failure of the function.
_SBNEExport int ne_grd_setX2(VGradientBase* g, RAVector* x2);

/// @brief Predicates returning @c true if this VLinearGradient object's "y2"  RAVector object is set.
/// @param g a pointer to the VLinearGradient object.
/// @return @c true if the "y2"  RAVector object of this VLinearGradient object is set, @c false if either the "y2"  RAVector object is not set or the object is @c NULL or not a VLinearGradient.
_SBNEExport bool ne_grd_isSetY2(VGradientBase* g);
...
/// @brief Sets the "y2" RAVector object of this VLinearGradient object.
/// @param g a pointer to the VLinearGradient object.
/// @param y2 a pointer to the  "y2" RAVector object.
/// @return integer value indicating success/failure of the function.
_SBNEExport int ne_grd_setY2(VGradientBase* g, RAVector* y2);

// VRadialGradient

/// @brief Predicates returning @c true if this VRadialGradient object's "cx"  RAVector object is set.
/// @param g a pointer to the VRadialGradient object.
/// @return @c true if the "cx"  RAVector object of this VRadialGradient object is set, @c false if either the "cx"  RAVector object is not set or the object is @c NULL or not a VRadialGradient.
_SBNEExport bool ne_grd_isSetCx(VGradientBase* g);
...
/// @brief Sets the "cx" RAVector object of this VRadialGradient object.
/// @param g a pointer to the VRadialGradient object.
/// @param cx a pointer to the  "cx" RAVector object.
/// @return integer value indicating success/failure of the function.
_SBNEExport int ne_grd_setCx(VGradientBase* g, RAVector* cx);

/// @brief Predicates returning @c true if this VRadialGradient object's "cy"  RAVector object is set.
/// @param g a pointer to the VRadialGradient object.
/// @return @c true if the "cy"  RAVector object of this VRadialGradient object is set, @c false if either the "cy"  RAVector object is not set or the object is @c NULL or not a VRadialGradient.
_SBNEExport bool ne_grd_isSetCy(VGradientBase* g);
...
/// @brief Sets the "cy" RAVector object of this VRadialGradient object.
/// @param g a pointer to the VRadialGradient object.
/// @param cy a pointer to the  "cy" RAVector object.
/// @return integer value indicating success/failure of the function.
_SBNEExport int ne_grd_setCy(VGradientBase* g, RAVector* cy);

/// @brief Predicates returning @c true if this VRadialGradient object's "fx"  RAVector object is set.
/// @param g a pointer to the VRadialGradient object.
/// @return @c true if the "fx"  RAVector object of this VRadialGradient object is set, @c false if either the "fx"  RAVector object is not set or the object is @c NULL or not a VRadialGradient.
_SBNEExport bool ne_grd_isSetFx(VGradientBase* g);
...
/// @brief Sets the "fx" RAVector object of this VRadialGradient object.
/// @param g a pointer to the VRadialGradient object.
/// @param fx a pointer to the  "fx" RAVector object.
/// @return integer value indicating success/failure of the function.
_SBNEExport int ne_grd_setFx(VGradientBase* g, RAVector* fx);

/// @brief Predicates returning @c true if this VRadialGradient object's "fy"  RAVector object is set.
/// @param g a pointer to the VRadialGradient object.
/// @return @c true if the "fy"  RAVector object of this VRadialGradient object is set, @c false if either the "fy"  RAVector object is not set or the object is @c NULL or not a VRadialGradient.
_SBNEExport bool ne_grd_isSetFy(VGradientBase* g);
...
/// @brief Sets the "fy" RAVector object of this VRadialGradient object.
/// @param g a pointer to the VRadialGradient object.
/// @param fy a pointer to the  "fy" RAVector object.
/// @return integer value indicating success/failure of the function.
_SBNEExport int ne_grd_setFy(VGradientBase* g, RAVector* fy);

/// @brief Predicates returning @c true if this VRadialGradient object's "r"  RAVector object is set.
/// @param g a pointer to the VRadialGradient object.
/// @return @c true if the "r"  RAVector object of this VRadialGradient object is set, @c false if either the "r"  RAVector object is not set or the object is @c NULL or not a VRadialGradient.
_SBNEExport bool ne_grd_isSetR(VGradientBase* g);
...
/// @brief Sets the "r" RAVector object of this VRadialGradient object.
/// @param g a pointer to the VRadialGradient object.
/// @param r a pointer to the  "r" RAVector object.
/// @return integer value indicating success/failure of the function.
_SBNEExport int ne_grd_setR(VGradientBase* g, RAVector* r);

// VGradientStop

/// @brief Get the value of a desired feature of a VGradientStop object.
/// @param s a pointer to the VGradientStop object.
/// @param infoList a list containg the info about the desired feature.
/// @return a string containing the value of the desired feature of the VGradientStop object,  or an empty string if either the value of the desired feature is not set or the desired feature does not exist.
_SBNEExport const std::string ne_gstp_get(VGradientStop* s, std::unordered_map<std::string, std::string> infoList);

/// @brief Set the value of a desired feature of a VGradientStop object.
/// @param s a pointer to the VGradientStop object.
/// @param infoList a list containg the info about the desired feature and its value.
/// @return integer value indicating success/failure of the function.
_SBNEExport int ne_gstp_set(VGradientStop* s, std::unordered_map<std::string, std::string> infoList);

/// @brief Predicates returning @c true if the "offset" attribute of this VGradientStop is set.
/// @param s a pointer to the VGradientStop object.
...
/// @brief Sets the "offset" RAVector object of this VGradientStop object.
/// @param s a pointer to the VGradientStop object.
/// @param offset a pointer to the  "offset" RAVector object.
/// @return integer value indicating success/failure of the function.
_SBNEExport int ne_gstp_setOffset(VGradientStop* s, RAVector* offset);

/// @brief Predicates returning @c true if the "color" attribute of this VGradientStop is set.
/// @param s a pointer to the VGradientStop object.
...
/// @brief Sets the value of the "stop-color" attribute of this VGradientStop object.
/// @param s a pointer to the VGradientStop object.
/// @param color a  string to use as the value of the "stop-color" attribute of this VGradientStop object.
/// @return integer value indicating success/failure of the function.
_SBNEExport int ne_gstp_setColor(VGradientStop* s, const std::string& color);

// VLineEnding

/// @brief Get the value of a desired feature of a VLineEnding object.
/// @param lE a pointer to the VLineEnding object.
/// @param infoList a list containg the info about the desired feature.
/// @return a string containing the value of the desired feature of the VLineEnding object,  or an empty string if either the value of the desired feature is not set or the desired feature does not exist.
_SBNEExport const std::string ne_le_get(VLineEnding* lE, std::unordered_map<std::string, std::string> infoList);

/// @brief Set the value of a desired feature of a VLineEnding object.
/// @param lE a pointer to the VLineEnding object.
/// @param infoList a list containg the info about the desired feature and its value.
/// @return integer value indicating success/failure of the function.
_SBNEExport int ne_le_set(VLineEnding* lE, std::unordered_map<std::string, std::string> infoList);
...
/// @brief Predicates returning @c true if this VLineEnding object's LBox object is set.
/// @param lE a pointer to the VLineEnding object.
...
/// @brief Predicates returning @c true if this VLineEnding object's VRenderGroup object is set.
/// @param lE a pointer to the VLineEnding object.
...
/// @brief Predicates returning @c true if the "enablerotationmapping" attribute of this VLineEnding is set.
/// @param lE a pointer to the VLineEnding object.
...
/// @brief Get the value of a desired feature of a VGlobalStyle object.
/// @param s a pointer to the VGlobalStyle object.
/// @param infoList a list containg the info about the desired feature.
/// @return a string containing the value of the desired feature of the VGlobalStyle object,  or an empty string if either the value of the desired feature is not set or the desired feature does not exist.
_SBNEExport const std::string ne_stl_get(VGlobalStyle* s, std::unordered_map<std::string, std::string> infoList);

/// @brief Set the value of a desired feature of a VGlobalStyle object.
/// @param s a pointer to the VGlobalStyle object.
/// @param infoList a list containg the info about the desired feature and its value.
/// @return integer value indicating success/failure of the function.
_SBNEExport int ne_stl_set(VGlobalStyle* s, std::unordered_map<std::string, std::string> infoList);

/// @brief Automattically sets pre-defined values to the features of the VGlobalStyle object based on its "type" or "role" attribute.
/// @param s a pointer to the VGlobalStyle object.
/// @param type a StyleType to use as the value of the "type" attribute of this VGlobalStyle object.
/// @param role a RxnRoleType to use as the value of the "role" attribute of this VGlobalStyle object.
/// @return integer value indicating success/failure of the function.
_SBNEExport int ne_stl_setStyleValues(VGlobalStyle* s, StyleType type = NUM_StyleType, RxnRoleType role = NUM_RxnRoleType);

/// @brief Predicates returning @c true if this VGlobalStyle object's VRenderGroup object is set.
/// @param s a pointer to the VGlobalStyle object.
...
/// @brief Get the value of a desired feature of a VRenderGroup object.
/// @param g a pointer to the VRenderGroup object.
/// @param infoList a list containg the info about the desired feature.
/// @return a string containing the value of the desired feature of the VRenderGroup object,  or an empty string if either the value of the desired feature is not set or the desired feature does not exist.
_SBNEExport const std::string ne_grp_get(VRenderGroup* g, std::unordered_map<std::string, std::string> infoList);

/// @brief Set the value of a desired feature of a VRenderGroup object.
/// @param g a pointer to the VRenderGroup object.
/// @param infoList a list containg the info about the desired feature and its value.
/// @return integer value indicating success/failure of the function.
_SBNEExport int ne_grp_set(VRenderGroup* g, std::unordered_map<std::string, std::string> infoList);

/// @brief Predicates returning @c true if the "stroke" attribute of this VRenderGroup is set.
/// @param g a pointer to the VRenderGroup object.
...
/// @brief Predicates returning @c true if the "strokewidth" attribute of this VRenderGroup is set.
/// @param g a pointer to the VRenderGroup object.
...
/// @brief Predicates returning @c true if the "dasharray" attribute of this VRenderGroup is set.
/// @param g a pointer to the VRenderGroup object.
...
/// @brief Predicates returning @c true if the "fil" attribute of this VRenderGroup is set.
/// @param g a pointer to the VRenderGroup object.
...
/// @brief Predicates returning @c true if the "filrule" attribute of this VRenderGroup is set.
/// @param g a pointer to the VRenderGroup object.
...
/// @brief Predicates returning @c true if the "fontfamily" attribute of this VRenderGroup is set.
/// @param g a pointer to the VRenderGroup object.
...
/// @brief Predicates returning @c true if this VRenderGroup object's "fontsize"  RAVector object is set.
/// @param g a pointer to the VRenderGroup object.
...
/// @brief Predicates returning @c true if the "fontstyle" attribute of this VRenderGroup is set.
/// @param g a pointer to the VRenderGroup object.
...
/// @brief Predicates returning @c true if the "fontweight" attribute of this VRenderGroup is set.
/// @param g a pointer to the VRenderGroup object.
...
/// @brief Predicates returning @c true if the "textanchor" attribute of this VRenderGroup is set.
/// @param g a pointer to the VRenderGroup object.
...
/// @brief Predicates returning @c true if the "vtextanchor" attribute of this VRenderGroup is set.
/// @param g a pointer to the VRenderGroup object.
...
/// @brief Predicates returning @c true if the "starthead" attribute of this VRenderGroup is set.
/// @param g a pointer to the VRenderGroup object.
...
/// @brief Predicates returning @c true if the "endhead" attribute of this VRenderGroup is set.
/// @param g a pointer to the VRenderGroup object.
...
/// @brief Get the value of a desired feature of a VTransformation2D object.
/// @param gS a pointer to the VTransformation2D object.
/// @param infoList a list containg the info about the desired feature.
/// @return a string containing the value of the desired feature of the VTransformation2D object,  or an empty string if either the value of the desired feature is not set or the desired feature does not exist.
_SBNEExport const std::string ne_gs_get(VTransformation2D* gS, std::unordered_map<std::string, std::string> infoList);

/// @brief Set the value of a desired feature of a VTransformation2D object.
/// @param gS a pointer to the VTransformation2D object.
/// @param infoList a list containg the info about the desired feature and its value.
/// @return integer value indicating success/failure of the function.
_SBNEExport int ne_gs_set(VTransformation2D* gS, std::unordered_map<std::string, std::string> infoList);
...
/// @brief Predicates returning @c true if the "stroke" attribute of this VTransformation2D is set.
/// @param gS a pointer to the VTransformation2D object.
...
/// @brief Predicates returning @c true if the "strokewidth" attribute of this VTransformation2D is set.
/// @param gS a pointer to the VTransformation2D object.
...
/// @brief Predicates returning @c true if the "dasharray" attribute of this VTransformation2D is set.
/// @param gS a pointer to the VTransformation2D object.
...
/// @brief Predicates returning @c true if the "fill" attribute of this VTransformation2D is set.
/// @param gS a pointer to the VTransformation2D object.
...
/// @brief Predicates returning @c true if the "fillrule" attribute of this VTransformation2D is set.
/// @param gS a pointer to the VTransformation2D object.
...
/// @brief Get the value of a desired feature of a VImage object.
/// @param gS a pointer to the VImage object.
/// @param infoList a list containg the info about the desired feature.
/// @return a string containing the value of the desired feature of the VImage object,  or an empty string if either the value of the desired feature is not set or the desired feature does not exist.
_SBNEExport const std::string ne_img_get(VTransformation2D* gS, std::unordered_map<std::string, std::string> infoList);

/// @brief Set the value of a desired feature of a VImage object.
/// @param gS a pointer to the VImage object.
/// @param infoList a list containg the info about the desired feature and its value.
/// @return integer value indicating success/failure of the function.
_SBNEExport int ne_img_set(VTransformation2D* gS, std::unordered_map<std::string, std::string> infoList);

/// @brief Predicates returning @c true if this VImage object's "x"  RAVector object is set.
/// @param gS a pointer to the VImage object.
...
/// @brief Predicates returning @c true if this VImage object's "y"  RAVector object is set.
/// @param gS a pointer to the VImage object.
...
/// @brief Predicates returning @c true if this VImage object's "width"  RAVector object is set.
/// @param gS a pointer to the VImage object.
...
/// @brief Predicates returning @c true if this VImage object's "height"  RAVector object is set.
/// @param gS a pointer to the VImage object.
...
/// @brief Predicates returning @c true if the "href" attribute of this VImage is set.
/// @param gS a pointer to the VImage object.
...
/// @brief Get the value of a desired feature of a RCurve object.
/// @param gS a pointer to the RCurve object.
/// @param infoList a list containg the info about the desired feature.
/// @return a string containing the value of the desired feature of the RCurve object,  or an empty string if either the value of the desired feature is not set or the desired feature does not exist.
_SBNEExport const std::string ne_rc_get(VTransformation2D* gS, std::unordered_map<std::string, std::string> infoList);

/// @brief Set the value of a desired feature of a RCurve object.
/// @param gS a pointer to the RCurve object.
/// @param infoList a list containg the info about the desired feature and its value.
/// @return integer value indicating success/failure of the function.
_SBNEExport int ne_rc_set(VTransformation2D* gS, std::unordered_map<std::string, std::string> infoList);
...
/// @brief Predicates returning @c true if the "starthead" attribute of this RCurve is set.
/// @param gS a pointer to the RCurve object.
...
/// @brief Predicates returning @c true if the "endhead" attribute of this RCurve is set.
/// @param gS a pointer to the RCurve object.
...
/// @brief Get the value of a desired feature of a VText object.
/// @param gS a pointer to the VText object.
/// @param infoList a list containg the info about the desired feature.
/// @return a string containing the value of the desired feature of the VText object,  or an empty string if either the value of the desired feature is not set or the desired feature does not exist.
_SBNEExport const std::string ne_txt_get(VTransformation2D* gS, std::unordered_map<std::string, std::string> infoList);

/// @brief Set the value of a desired feature of a VText object.
/// @param gS a pointer to the VText object.
/// @param infoList a list containg the info about the desired feature and its value.
/// @return integer value indicating success/failure of the function.
_SBNEExport int ne_txt_set(VTransformation2D* gS, std::unordered_map<std::string, std::string> infoList);

/// @brief Predicates returning @c true if this VText object's "x"  RAVector object is set.
/// @param gS a pointer to the VText object.
...
/// @brief Predicates returning @c true if this VText object's "y"  RAVector object is set.
/// @param gS a pointer to the VText object.
...
/// @brief Predicates returning @c true if the "fontfamily" attribute of this VText is set.
/// @param gS a pointer to the VText object.
...
/// @brief Predicates returning @c true if this VText object's "fontsize"  RAVector object is set.
/// @param gS a pointer to the VText object.
...
/// @brief Predicates returning @c true if the "fontstyle" attribute of this VText is set.
/// @param gS a pointer to the VText object.
...
/// @brief Predicates returning @c true if the "fontweight" attribute of this VText is set.
/// @param gS a pointer to the VText object.
...
/// @brief Predicates returning @c true if the "textanchor" attribute of this VText is set.
/// @param gS a pointer to the VText object.
...
/// @brief Predicates returning @c true if the "vtextanchor" attribute of this VText is set.
/// @param gS a pointer to the VText object.
...
/// @brief Get the value of a desired feature of a VRectangle object.
/// @param gS a pointer to the VRectangle object.
/// @param infoList a list containg the info about the desired feature.
/// @return a string containing the value of the desired feature of the VRectangle object,  or an empty string if either the value of the desired feature is not set or the desired feature does not exist.
_SBNEExport const std::string ne_rec_get(VTransformation2D* gS, std::unordered_map<std::string, std::string> infoList);

/// @brief Set the value of a desired feature of a VRectangle object.
/// @param gS a pointer to the VRectangle object.
/// @param infoList a list containg the info about the desired feature and its value.
/// @return integer value indicating success/failure of the function.
_SBNEExport int ne_rec_set(VTransformation2D* gS, std::unordered_map<std::string, std::string> infoList);

/// @brief Predicates returning @c true if this VRectangle object's "x"  RAVector object is set.
/// @param gS a pointer to the VRectangle object.
...
/// @brief Predicates returning @c true if this VRectangle object's "y" RAVector object is set.
/// @param gS a pointer to the VRectangle object.
...
/// @brief Predicates returning @c true if this VRectangle object's "width" RAVector object is set.
/// @param gS a pointer to the VRectangle object.
...
/// @brief Predicates returning @c true if this VRectangle object's "height" RAVector object is set.
/// @param gS a pointer to the VRectangle object.
...
/// @brief Predicates returning @c true if this VRectangle object's "rx" RAVector object is set.
/// @param gS a pointer to the VRectangle object.
...
/// @brief Predicates returning @c true if this VRectangle object's "ry" RAVector object is set.
/// @param gS a pointer to the VRectangle object.
...
/// @brief Predicates returning @c true if the "ratio" attribute of this VRectangle is set.
/// @param gS a pointer to the VRectangle object.
...
/// @brief Get the value of a desired feature of a VEllipse object.
/// @param gS a pointer to the VEllipse object.
/// @param infoList a list containg the info about the desired feature.
/// @return a string containing the value of the desired feature of the VEllipse object,  or an empty string if either the value of the desired feature is not set or the desired feature does not exist.
_SBNEExport const std::string ne_elp_get(VTransformation2D* gS, std::unordered_map<std::string, std::string> infoList);

/// @brief Set the value of a desired feature of a VEllipse object.
/// @param gS a pointer to the VEllipse object.
/// @param infoList a list containg the info about the desired feature and its value.
/// @return integer value indicating success/failure of the function.
_SBNEExport int ne_elp_set(VTransformation2D* gS, std::unordered_map<std::string, std::string> infoList);

/// @brief Predicates returning @c true if this VEllipse object's "cx" RAVector object is set.
/// @param gS a pointer to the VEllipse object.
...
/// @brief Predicates returning @c true if this VEllipse object's "cy" RAVector object is set.
/// @param gS a pointer to the VEllipse object.
...
/// @brief Predicates returning @c true if this VEllipse object's "rx" RAVector object is set.
/// @param gS a pointer to the VEllipse object.
...
/// @brief Predicates returning @c true if this VEllipse object's "ry" RAVector object is set.
/// @param gS a pointer to the VEllipse object.
...
/// @brief Predicates returning @c true if the "ratio" attribute of this VEllipse is set.
/// @param gS a pointer to the VEllipse object.
...
/// @brief Get the value of a desired feature of a VPolygon object.
/// @param gS a pointer to the VPolygon object.
/// @param infoList a list containg the info about the desired feature.
/// @return a string containing the value of the desired feature of the VPolygon object,  or an empty string if either the value of the desired feature is not set or the desired feature does not exist.
_SBNEExport const std::string ne_plg_get(VTransformation2D* gS, std::unordered_map<std::string, std::string> infoList);

/// @brief Set the value of a desired feature of a VPolygon object.
/// @param gS a pointer to the VPolygon object.
/// @param infoList a list containg the info about the desired feature and its value.
/// @return integer value indicating success/failure of the function.
_SBNEExport int ne_plg_set(VTransformation2D* gS, std::unordered_map<std::string, std::string> infoList);
...
/// @brief Get the value of a desired feature of a RenPoint object.
/// @param rp a pointer to the RenPoint object.
/// @param infoList a list containg the info about the desired feature.
/// @return a string containing the value of the desired feature of the RenPoint object,  or an empty string if either the value of the desired feature is not set or the desired feature does not exist.
_SBNEExport const std::string ne_vrx_get(RenPoint* rp, std::unordered_map<std::string, std::string> infoList);

/// @brief Set the value of a desired feature of a RenPoint object.
/// @param rp a pointer to the RenPoint object.
/// @param infoList a list containg the info about the desired feature and its value.
/// @return integer value indicating success/failure of the function.
_SBNEExport int ne_vrx_set(RenPoint* rp, std::unordered_map<std::string, std::string> infoList);
...
/// @brief Predicates returning @c true if this RenPoint object is of type RCubicBezier
...
/// @brief Get the value of a desired feature of a RPoint object.
/// @param point a pointer to the RPoint object.
/// @param infoList a list containg the info about the desired feature.
/// @return a string containing the value of the desired feature of the RPoint object,  or an empty string if either the value of the desired feature is not set or the desired feature does not exist.
_SBNEExport const std::string ne_rp_get(RPoint* point, std::unordered_map<std::string, std::string> infoList);

/// @brief Set the value of a desired feature of a RPoint object.
/// @param point a pointer to the RPoint object.
/// @param infoList a list containg the info about the desired feature and its value.
/// @return integer value indicating success/failure of the function.
_SBNEExport int ne_rp_set(RPoint* point, std::unordered_map<std::string, std::string> infoList);
